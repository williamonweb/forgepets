...
function reportView(){
 ...
 return `<section class="reports-pro">
  <div class="reports-hero"><div><span>INTELIGÊNCIA DO PET SHOP</span><h2>Relatórios de serviços e desempenho</h2><p>Analise banho, tosa e demais serviços com filtros combinados e resultados em tempo real.</p></div><button class="btn ghost" data-action="export-service-report">⇩ Exportar CSV</button></div>
